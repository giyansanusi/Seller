<header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo">Reseller <span class="lite">Admin</span></a>
            <!--logo end-->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li class="eborder-top">
                                <a href="<?php echo site_url(); ?>/admin/c_profile"><i class="icon_profile"></i> My Profile</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>index.php/admin/c_login/logout"><i class="icon_key_alt"></i> Log Out</a>
                            </li>
                            <li>
