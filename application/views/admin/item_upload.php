                  ...
                  <div class="padd">
                      ...
                      <div class="form quick-post">
                                      ...
                                      <form class="form-horizontal">
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-lg-1" for="content">Harga Barang</label>
                                            <div class="col-lg-10">
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-lg-1">Kategori Barang</label>
                                            <div class="col-lg-10">                               
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-lg-1" for="content">Berat Barang</label>
                                            <div class="col-lg-10">
                                              <input type="text" class="form-control" id="hargabarang">
                                            </div>
                                          </div> 
