                    ...
                    <div class="container">
                        ...
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            <td><a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/admin/c_profile/editadmin/<?php echo $IDADMIN; ?>">Edit</a><?php echo "&nbsp;&nbsp;"; ?><a class="btn btn-default" href="<?php echo base_url(); ?>index.php/admin/c_profile/changepassword/<?php echo $IDADMIN; ?>">Change Password</a></td>
