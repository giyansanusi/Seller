								...
								<ul class="dropdown-menu multi">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="kitchen.html"><img src="<?php echo base_url(); ?>assets/web/images/me.png" class="img-responsive" alt=""></a>
										</div>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="care.html"><img src="<?php echo base_url(); ?>assets/web/images/me1.png" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="hold.html"><img src="<?php echo base_url(); ?>assets/web/images/me2.png" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
