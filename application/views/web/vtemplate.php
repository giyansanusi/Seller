...
<!--- start-rate---->
<script src="<?php echo base_url(); ?>assets/web/js/jstarbox.js"></script>
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/web/css/jstarbox.css" type="text/css" media="screen" charset="utf-8" />
		<script type="text/javascript">
			jQuery(function() {
...
<body>
<a href="offer.html"><img src="<?php echo base_url(); ?>assets/web/images/download.png" class="img-head" alt=""></a>
...
<!-- VIDEO BANNER -->
	<?php $this->load->view('web/videobanner'); ?>
<!-- VIDEO BANNER END -->
...
<!-- CONTENT PROMO -->
	<?php $this->load->view('web/contentpromo'); ?>
<!-- CONTENT PROMO END -->

<!-- CAROUSEL -->
	<?php $this->load->view('web/carousel'); ?>
<!-- CAROUSEL END -->

<!-- CONTENT2 -->
	<?php $this->load->view('web/content2'); ?>
<!-- CONTENT2 END -->
...
<!-- //for bootstrap working -->
<script type='text/javascript' src="<?php echo base_url(); ?>assets/web/js/jquery.mycart.js"></script>
  <script type="text/javascript">
  $(function () {
  ...
  <?php $this->load->view('web/detailbarang'); ?>
